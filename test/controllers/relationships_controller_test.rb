...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { grapesort_id: @relationship.grapesort_id, ratio: @relationship.ratio, varietywine_id: @relationship.varietywine_id }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { grapesort_id: @relationship.grapesort_id, ratio: @relationship.ratio, varietywine_id: @relationship.varietywine_id }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
